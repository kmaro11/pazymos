...
<article class="pt-20 pb-[100px] px-4 md:px-14">
    <div class="max-w-[1320px] mx-auto">
        <div class="font-['Helvetica_Neue'] text-[14px] font-medium leading-[22px] text-green mb-4 py-[5px] px-3 rounded-[10px] bg-gray-300 w-max">
            {{ $article['category'] }}
        </div>
        <div class="flex justify-between mb-[60px]">
            <div class="max-w-[870px] w-full">
                ...
                <p class="text-base font-normal leading-6 font-['Helvetica_Neue'] text-black-100">{{ $article['excerpt'] }}</p>
            </div>
            <div class="flex-shrink-0">
                <div class="text-black font-['Helvetica_Neue'] text-sm font-normal leading-[22px] mb-3">Dalintis šiuo įrašu</div>
