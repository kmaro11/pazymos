...
<x-header />
<!-- TODO: NEED MOBILE -->
<article class="pt-4 md:pt-14 pb-20 md:pb-[100px] px-4 md:px-14">
    <div class="max-w-[1440px] mx-auto">
        <div class="text-[14px] font-medium leading-[22px] text-green mb-6 md:mb-4 py-[5px] px-3 rounded-[10px] bg-gray-300 w-max ml-auto md:ml-0">
            {{ $article['category'] }}
        </div>
        <div class="flex flex-col md:flex-row justify-between mb-3 md:mb-[60px]">
            <div class="max-w-[870px] w-full">
                <h1 class="text-[32px] md:text-[48px] font-bold leading-[42px] md:leading-[56px] md:tracking-[-1.68px] mb-4 text-black-100">{{ $article['title'] }}</h1>
                <p class="text-base font-normal leading-6 text-black-100">{{ $article['excerpt'] }}</p>
            </div>
            <div class="flex-shrink-0 mt-4 md:mt-0">
                <div class="hidden md:block text-black text-sm font-normal leading-[22px] mb-3">Dalintis šiuo įrašu</div>
        ...
        <div class="relative w-full h-[370px] mb-2 md:mb-[60px]">
