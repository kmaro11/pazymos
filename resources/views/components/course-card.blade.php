...
<div class="bg-white rounded-[20px] md:rounded-3xl shadow-card flex flex-col p-2 md:p-2.5 pb-6 md:pb-8 h-full md:min-h-[580px]">
    <div class="relative w-full h-[206px] md:h-[250px] flex items-center justify-center mb-6 md:mb-5">
        ...
        <div class="absolute top-2 md:top-2.5 left-2 md:left-2.5 flex gap-1.5 md:gap-2">
            ...
            <div class="bg-white rounded-[100px] flex items-center justify-center h-6 md:h-[30px] text-sm font-medium leading-6 text-black-100 px-3 w-max text-center ">{{ $label }}</div>
            @endforeach
        </div>
    ...
    <div class="px-2.5 flex flex-col flex-1 justify-between">
        <h3 class="text-black-100 text-lg md:text-2xl font-medium leading-6 md:leading-[34px] mb-5 md:mb-0">{{ $title }}</h3>
        <div>
            <div class="text-black-100 text-base font-medium leading-6 mb-4">Į paketą įeinantys mokymai:</div>
            <ul class="mb-5">
                ...
                <li class="flex items-center gap-2">
                    ...
                    <span class="text-black-100 text-base font-normal leading-6">{{ $feature }}</span>
                </li>
                @endforeach
            </ul>
