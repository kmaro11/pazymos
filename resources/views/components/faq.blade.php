...
<!-- Gediminai, visuose puslapiuose, kur yra basket, pb-[160px]!!!!!!!!!!!!!!! Nes sticky basket uzdengia faq -->
 <!-- Taip pat perziurekit styles is sio componento. Nes pakeitimai nebuvo sukelti i production. -->
<section {{ $attributes->merge(['class' => 'bg-gray-100 pb-[60px] md:pb-[100px]']) }}>
    <div class="max-w-[645px] mx-auto px-4 md:px-14">
        ...
        <div class="space-y-4 md:space-y-6" id="faq-accordion">
            ...
            <div class="faq-item">
                <button class="faq-question flex justify-between items-center w-full py-3 pl-5 md:pl-9 pr-[14px] text-left bg-blue/30 rounded-[100px] border border-gray-400">
                    <span class="text-black-100 text-lg font-normal leading-6 md:leading-8">{{ $faq['question'] }}</span>
                    <span class="faq-arrow-icon transition-transform duration-300 w-6 h-6 md:w-9 md:h-9 flex items-center justify-center flex-shrink-0">
