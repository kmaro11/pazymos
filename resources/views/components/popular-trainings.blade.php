            ...
            <div class="lg:px-14 px-4">
                <div class="lg:pl-2.5">
                    ...
                    <div class="flex flex-col md:flex-row md:items-end md:justify-between mb-[60px] md:mb-12">
                        <div>
                            <h2 class="text-dark-100 text-center md:text-left  text-[32px] md:text-[48px] font-medium leading-[42px] md:leading-[58px] mb-4 md:mb-[30px]">
                                Populiariausi mokymų komplektai
                            </h2>
                            <p class="text-dark-100 text-center md:text-left  text-base font-normal leading-6">
