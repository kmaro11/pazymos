...
<section class="bg-gray-100 px-4 sm:px-14 pt-4 md:pt-10 pb-[60px] md:pb-[100px]">
    <div class="max-w-[1320px] mx-auto flex flex-col lg:flex-row justify-between">
        <div class="max-w-[644px] w-full mb-[60px] lg:mb-0">
            ...
            <h1 class="text-black-100 font-['Helvetica_Neue'] text-[32px] md:text-[48px] font-medium leading-[42px] md:leading-[58px] mb-6">{{ $title }}</h1>
            <div class="space-y-6">
                @foreach($descriptions as $description)
                <p class="text-black-100 font-['Helvetica_Neue'] text-base font-normal leading-6">{{ $description }}</p>
                @endforeach
            </div>
        </div>
