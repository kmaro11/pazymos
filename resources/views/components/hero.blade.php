            ...
            <div class="flex flex-col gap-6">
                ...
                <a href="{{ route('trainings') }}" class="flex items-center bg-white hover:bg-green-100 transition-all duration-300 shadow-soft rounded-[100px] pl-2.5 lg:pl-4 pr-4 lg:pr-5 py-2 lg:py-4 gap-4 lg:w-max">
                    <div class="flex-shrink-0 rounded-full w-10 lg:w-[58px] h-10 lg:h-[58px] flex items-center justify-center bg-green-200">
                        <svg width="59" height="58" viewBox="0 0 59 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M36.7495 26.6465C36.1446 25.0405 35.2626 23.5531 34.1436 22.252C32.207 20.0103 29.6606 18.5625 27.6562 18.5625C27.5371 18.5626 27.4195 18.5899 27.3125 18.6425C27.2055 18.695 27.112 18.7713 27.039 18.8656C26.9661 18.9598 26.9157 19.0695 26.8916 19.1862C26.8676 19.303 26.8706 19.4237 26.9004 19.5391C27.5776 22.127 26.1738 24.2788 24.688 26.5566C23.457 28.4434 22.1875 30.3921 22.1875 32.625C22.1875 36.9326 25.6924 40.4375 30 40.4375C34.3076 40.4375 37.8125 36.9326 37.8125 32.625C37.8125 30.5107 37.4551 28.4995 36.7495 26.6465ZM31.5786 37.4438C31.0742 37.981 30.4419 38.0938 30 38.0938C29.5581 38.0938 28.9258 37.981 28.4214 37.4438C27.917 36.9067 27.6562 36.0547 27.6562 34.9688C27.6562 33.7412 28.0869 32.8066 28.5029 31.9033C28.7446 31.3789 28.9912 30.8452 29.1377 30.2739C29.1532 30.2118 29.1838 30.1544 29.2268 30.1069C29.2697 30.0594 29.3237 30.0231 29.384 30.0014C29.4442 29.9796 29.5089 29.973 29.5723 29.9821C29.6357 29.9913 29.6959 30.0158 29.7476 30.0537C30.1941 30.3992 30.5912 30.8044 30.9277 31.2578C31.8149 32.4297 32.3438 33.8174 32.3438 34.9688C32.3438 36.0547 32.0791 36.9106 31.5786 37.4438Z" fill="#204D51" />
                        </svg>
                ...
                <a href="{{ route('trainings') }}" class="flex items-center bg-white hover:bg-green-100 transition-all duration-300 shadow-soft rounded-[100px] pl-2.5 lg:pl-4 pr-4 lg:pr-5 py-2 lg:py-4 gap-4 lg:w-max">
                    <div class="flex-shrink-0 rounded-full w-10 lg:w-[58px] h-10 lg:h-[58px] flex items-center justify-center bg-green-200">
                        <svg width="59" height="58" viewBox="0 0 59 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="29.5" cy="29" r="29" fill="#F5FA9B" />
                            <path d="M30 19.3438C24.3999 19.3438 19.8438 23.8999 19.8438 29.5C19.8438 35.1001 24.3999 39.6562 30 39.6562C35.6001 39.6562 40.1562 35.1001 40.1562 29.5C40.1562 23.8999 35.6001 19.3438 30 19.3438ZM33.647 31.6885C33.189 32.2471 32.3579 33.1401 30.439 34.4429C30.3095 34.5315 30.1564 34.5789 29.9995 34.5789C29.8427 34.5789 29.6895 34.5315 29.5601 34.4429C27.6411 33.1401 26.8101 32.2456 26.3521 31.6885C25.3755 30.4985 24.9077 29.2764 24.9214 27.9531C24.9365 26.4365 26.1528 25.2026 27.6328 25.2026C28.6289 25.2026 29.3418 25.7217 29.7861 26.1992C29.8135 26.2282 29.8465 26.2513 29.8831 26.267C29.9197 26.2828 29.9592 26.2909 29.999 26.2909C30.0389 26.2909 30.0783 26.2828 30.1149 26.267C30.1515 26.2513 30.1845 26.2282 30.2119 26.1992C30.6567 25.7217 31.3691 25.2026 32.3652 25.2026C33.8452 25.2026 35.0615 26.4365 35.0767 27.9531C35.0913 29.2764 34.623 30.4985 33.647 31.6885Z" fill="#204D51" />
                        </svg>
