<div>
    <section class="lg:px-14 px-4 pt-4">
        <div class="max-w-[1320px] mx-auto">
            <div class=" flex flex-col lg:flex-row lg:items-start mb-[60px] md:mb-[100px] justify-between">
                <h1 class="max-w-[645px] text-[40px] lg:text-[74px] font-medium text-black-100 leading-[50px] lg:leading-[84px] font-['Helvetica_Neue'] mb-6 lg:mb-0">
                    Pagrindinis pavadinimas apie mokymus
                </h1>
                <div class="max-w-[644px] w-full lg:pt-[192px]">
                    <div class="space-y-6 mb-6 text-black-100 font-['Helvetica_Neue'] text-base font-normal leading-6">
    ...
    <section class="lg:px-14 px-4 pb-10 lg:pb-[100px]">
        <div class="max-w-[1320px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12">
            <h2 class="text-[32px] lg:text-[48px] font-medium text-black-100 leading-[42px] lg:leading-[58px] font-['Helvetica_Neue'] text-center lg:text-left">
                Mokymų kategorijos
            </h2>
            <div class="flex flex-col gap-6">
                <div class="flex items-center bg-white shadow-soft rounded-[100px] pl-2.5 lg:pl-4 pr-4 lg:pr-5 py-2 lg:py-4 gap-4 lg:w-max">
                    ...
                    <span class="text-black-100 font-medium text-base lg:text-2xl leading-6 lg:leading-normal font-['Helvetica_Neue']">
