...
<div class="bg-white rounded-[20px] md:rounded-3xl shadow-card flex flex-col p-2 md:p-2.5 pb-6 md:pb-8 h-full md:min-h-[580px]" data-training-title="{{ $title }}" data-training-filters="{{ implode(',', $filters) }}">
