<div id="modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 hidden">
    <div class="bg-white rounded-[30px] shadow-large-card max-w-[645px] w-full pb-9 pt-8 px-10 relative">
