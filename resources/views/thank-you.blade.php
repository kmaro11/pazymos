...
<section class="pt-[194px] pb-[200px] px-4 md:px-14">
    <h1 class="mb-6 text-black-100 text-center font-['Helvetica_Neue'] text-[48px] font-normal font-medium leading-[58px]">
        Dėkojame už pirkimą!
    </h1>
    <p class="mb-6 text-black-100 text-center font-['Helvetica_Neue'] text-base font-normal leading-6">
        Netrukus į nurodytą el. paštą gausite pirkimo patvirtinimo laišką su įsigytais mokymais.
    </p>
    <p class="mb-12 text-black-100 text-center font-['Helvetica_Neue'] text-base font-normal leading-6">
